package it.unibo.scafi.xc.implicitsinmethods.runtime.implementations

import it.unibo.scafi.xc.implicitsinmethods.language.semantics.exchange.{ ExchangeCalculusSemantics, NValues }
import it.unibo.scafi.xc.implicitsinmethods.runtime.AggregateRuntime

trait ExchangeCalculusRuntime extends AggregateRuntime {
  override type Language = Implementation
  override type VM = ExchangeVM

  trait Implementation extends ExchangeCalculusSemantics[DeviceID], SemanticsImplementation {
